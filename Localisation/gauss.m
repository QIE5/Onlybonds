function MatTracking = ULM2_localization2D(MatIn,ULM)
...
ULM.fwhm = [161, 31];
ULM.numberOfParticles = 12;
ULM.threshold = 99.5;   % adjust if too many/few detections
ULM.numberOfParticles = 20;
% Run localization - use MatIn, not frame1!
MatTracking = ULM2_localization2D(MatIn, ULM);
...
MatTracking
plot(MatTracking(:,3), MatTracking(:,2), 'r+', 'MarkerSize', 10, 'LineWidth', 2)